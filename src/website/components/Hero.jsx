...
export default function Hero({ onLaunchDemo, onBookDemo }) {
  return (
    <section className="relative flex min-h-[640px] items-start overflow-hidden px-5 pb-12 pt-16">
      <div className="mx-auto grid max-w-7xl items-start gap-8 lg:grid-cols-[1.05fr_0.95fr]">
        <motion.div initial={{ opacity: 0, y: 26 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="overflow-visible">
          <h1 className="mt-3 max-w-[780px] overflow-visible text-[3.15rem] font-black leading-[1.12] tracking-[-0.045em] text-white sm:text-[4.1rem] lg:text-[4.65rem] xl:text-[5.35rem]">
